...
export function LocationMap({
  ...
  return (
    ...
    >
      <motion.div
        className="relative overflow-hidden rounded-2xl bg-truf-card border border-white/10"
        style={{
      ...
      >
        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              ...
              />
              <motion.div
                className="absolute top-[20%] right-[10%] w-[10%] h-[25%] rounded-sm bg-white/10 border border-white/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.55 }}
              />
              <motion.div
                className="absolute top-[55%] left-[5%] w-[8%] h-[12%] rounded-sm bg-white/10 border border-white/5"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
              ...
              >
                ...
                >
                  ...
                  <circle cx="12" cy="9" r="2.5" className="fill-[#0a0f0d]" />
                </svg>
              </motion.div>
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          ...
          <div className="flex items-start justify-between">
            ...
            >
              <div className="w-1.5 h-1.5 rounded-full bg-truf-emerald" />
              <span className="text-[10px] font-medium text-white/60 tracking-wide uppercase">Live</span>
            </motion.div>
          </div>
          ...
          <div className="space-y-1">
            ...
            {/* Animated underline */}
            <motion.div
              className="h-px bg-gradient-to-r from-truf-emerald/50 via-truf-emerald/30 to-transparent"
      ...
      {/* Click hint */}
      <motion.p
        className="absolute -bottom-6 left-1/2 text-[10px] text-white/40 whitespace-nowrap"
        style={{ x: "-50%" }}
        initial={{ opacity: 0 }}
        animate={{
        ...
        transition={{ duration: 0.2 }}
      >
        {isExpanded ? (href ? "Click again to open in Google Maps" : "") : "Click to expand map"}
      </motion.p>
    </motion.div>
  )
}
